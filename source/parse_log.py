...
def main():
    args = get_options()
    print (args)
    #process_alignment_stats(args.input, args.prefix_align, os.path.join(args.output, args.alignment))
    ...
    process_assemble_stats(args.input, args.prefix_assemble, os.path.join(args.output, args.assemble))
